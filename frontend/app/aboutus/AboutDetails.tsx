    ...
    <div className="flex flex-col items-center text-justify justify-center gap-8 px-4 md:px-16 py-8 md:py-16 w-full bg-gray-100 mt-6">
      <div className="max-w-[1000px] w-full">
        ...
        <p className="text-[#40773b] text-base md:text-lg font-normal leading-normal text-center">
          ...
          vathals, ulunthankanji mix, kauvuni arisi mix, and various organic
          food powders. Each item is carefully made, keeping tradition alive and
          using pure organic ingredients, all processed without any artificial
          preservatives.
        </p>
        <p className="text-[#40773b] text-base md:text-lg font-normal leading-normal text-center">
          We grow our ingredients on our own land and process them in our
          factory, ensuring that our products retain their natural fiber and
          nutrients.
        </p>
        <p className="text-[#40773b] text-base md:text-lg font-normal leading-normal text-center">
